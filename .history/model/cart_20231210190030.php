...
function insert_bill($nameuser, $tel,$addr,$ngaydathang,$tongdonhang,$newpricesp)
{
    $sql = "INSERT INTO bill(bill_name,bill_tel,bill_addr,bill_pttt,ngaydathang,total) VALUES ('$namesp','$newpricesp','$pricesp','$imgsp','$des','$iddm')";
    pdo_execute($sql);
}