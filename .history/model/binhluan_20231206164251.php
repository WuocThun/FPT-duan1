...
function update_binhluan($id, $comment,$idpro,$iduser,$daycomment)
{
    $sql = "update binhluan set comment='" . $comment . "', idpro='".$idpro."', iduser='".$iduser."',daycomment='".$daycomment."' where id=" . $id;
    pdo_execute($sql);
}