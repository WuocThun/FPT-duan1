...
{
   if ($imgsp != "")
      $sql = "update sanpham set iddm='" . $iddm . "',namesp='" . $namesp . "',newpricesp='" . $newpricesp . "', pricesp='" . $pricesp . "',imgsp='" . $imgsp . "',des='" . $des . "' where id=" . $id;    $sql = "update sanpham set iddm='" . $iddm . "',namesp='" . $namesp . "',newpricesp='" . $newpricesp . "',pricesp='" . $pricesp . "',des='" . $des . "' where id=" . $id;
   pdo_execute($sql);
}