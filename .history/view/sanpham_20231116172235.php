...
<head>
    ...
    <style>
        .ds{
      animation: bounce 2s infinite alternate ease-in-out; /* Áp dụng animation với tên là "bounce" và sử dụng ease-in-out để làm mượt mà hơn */
      transition: transform 0.3s; /* Thêm transition cho hiệu ứng nhảy */
        }
      /* Định nghĩa keyframes cho animation */
    @keyframes bounce {
      0%, 100% {
        transform: translateY(0); /* Tại điểm đầu và cuối, không thay đổi vị trí theo trục y */
      }
      50% {
        transform: translateY(-5px); /* Tại giữa thời gian, nhảy lên 10px */
      }
    }
