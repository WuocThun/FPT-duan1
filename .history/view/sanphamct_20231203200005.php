    ...
    <style>
        ...
        .tsp input:hover,.tableBl input:hover {
...
?>
  ...
  <label for="star1"></label>
           ...
           <a href="index.php?act=thanhtoan">
            <input >Mua ngay</input></a> <input>Thêm vào giỏ hàng</input>
            </div>
            </div>
        </div>

        <div class="tableBl">
    <!-- <iframe class="bl" src="view/binhluan.php" frameborder="0" width="100%" height="300px"></iframe> -->
<table class="bl">
                <tr>
                    <th>BÌNH LUẬN</th>
                    <th>USER</th>
...
<form action="index.php?act=sanphamct" method="post">
            ...
            <input name="guibinhluan" type="submit">Gửi bình luận</input>
            </div>
            </form>
