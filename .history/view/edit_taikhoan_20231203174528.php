...
<?php
if (isset($_SESSION['userdn'])&& (is_array($_SESSION[]))) {
    # code...
}
?>
        <form onsubmit="" method="post">

                        <input type="text" id="name" name="user" placeholder="Tên Đăng nhập"><br><br>
                        ...
                        <input type="text" id="addrr" name="addr" placeholder="Address"><br><br>
