...
?>
    <div class="tongtt">
        ...
        <form onsubmit="return thanhtoan()" method="post">
            <input id="hoten" name="ho" type="text" placeholder="Họ"> <input name="ten" id="hoten" type="text" >
            <br>
            <div id="namettError" class="error"></div>
            <br><input type="text" name="user" placeholder="Tên tài khoản" value="<?=$name?>" id="namett"> <br>
            <div id="accError" class="error"></div>
            <br><input type="text" value="<?=$tel?>" placeholder="Số điện thoại" maxlength="10" id="teltt"> <br>
            <div id="telError" class="error"></div>
            <br><input type="text" value="addr" placeholder="Địa chỉ" id="addtt"> <br>
            <div id="addError" class="error"></div><br>
            <input type="checkbox">Thanh toán sau khi nhận hàng <br>
            <input type="submit" value="Thanh Toán" `>
            <p style:"color:blue">Bạn cần nhập thêm thông tin để hoàn thiện</p>
        </form>
