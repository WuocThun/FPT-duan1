...
?>
        <form onsubmit="" method="post">
                        ...
                        <input type="password" id="pass" name="pass" value="<?=$user?>"><br><br>
                        <div id="passwordError" class="error"></div>
                 
                        <input type="text" id="email" name="email" value="<?=$user?>"><br><br>
                        <div id="emailError" class="error"></div>
               
                        <input type="number" id="phone" name="phone" value="<?=$user?>"><br><br>
                        <div id="phoneError" class="error"></div>
                

                        <input type="text" id="addrr" name="addr" value="<?=$user?>"><br><br>
