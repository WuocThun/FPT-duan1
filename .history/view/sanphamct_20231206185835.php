            ...
            ?>
                <div class="spct">
                    ...
                    <div id="tsp" class="tsp">
                        ...
                        <form action="index.php?act=giohang1" method="post"></form>
                        <input type="text" name="id" value="id" value="$id" >
                        <!-- <div class="rating">
            ...
            <div class="row-flex">
                <a href="index.php?act=thanhtoan">
                    ...
                    $sesi = $_SESSION['userdn'];
                        if(isset($sesi)){
                        echo '    <a href="index.php?act=giohang1">
                            <button name="addtocard" >Thêm vào giỏ hàng</button></a> ';
                        }
                        else{
                            ?>
                            echo 'Đăng nhập để add giỏ hàng';
